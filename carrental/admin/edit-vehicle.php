...
<head>
	...
	<title>Burengo Car Rental | Editar Vehículos Info</title>
...
<?php if($msg){?><div class="succWrap"><strong>CORRECTO</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Vehículo Titulo<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Seleccione la Marca<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Resumén del Vehículo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Pricio Por Día(en USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-12">
<h4><b>Imagenes de Vehículos</b></h4>
</div>
</div>
...
<label for="inlineCheckbox3"> Frenos Antibloqueo </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Bolsas de Aire Chofer</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="driverairbag" value="1">
<label for="inlineCheckbox2">Bolsas de Aire</label>
<?php } ?>
</div>
<div class="col-sm-3">
<?php if($result->DriverAirbag==1)
...
<label for="inlineCheckbox3"> Bolsas de Aire Pasajero </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor de Choque </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
