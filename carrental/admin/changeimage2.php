...
<head>
	...
	<title>Burengo Car Rental | Admin Actualizar Imagen 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehículo Imagen 2 </h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imagen Actual 2</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Subir Nueva Imagen 2<span style="color:red">*</span></label>
												<div class="col-sm-8">
