...
<head>
	...
	<title>Burengo Car Rental | Admin Actualizar Imagen 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehículo Imagen 3 </h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imagen Actual 3</label>
<?php 
$id=intval($_GET['imgid']);
