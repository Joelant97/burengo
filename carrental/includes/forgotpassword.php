...
$chngpwd1->execute();
echo "<script>alert('Su contraseña ha cambiado exitosamente');</script>";
}
else {
echo "<script>alert('El Email o el Teléfono no es válido');</script>";
}
}
...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Su Teléfono Registrado*" required="">
                </div>
  <div class="form-group">
                  <input type="password" name="newpassword" class="form-control" placeholder="Nueva Contraseña*" required="">
                </div>
  <div class="form-group">
                  <input type="password" name="confirmpassword" class="form-control" placeholder="Confirme Contraseña*" required="">
                </div>
                <div class="form-group">
                  <input type="submit" value="Restablecer mi Contraseña" name="update" class="btn btn-block">
                </div>
              </form>
              <div class="text-center">
                <p class="gray_text">Por razones de seguridad, no almacenamos su contraseña. Su contraseña se restablecerá y se enviará una nueva.</p>
